...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SwiftFeatureConfigs.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/SwiftFeatureConfigs'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Dallas Johnson' => 'dallasj001@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/SwiftFeatureConfigs.git', :tag => s.version.to_s }
